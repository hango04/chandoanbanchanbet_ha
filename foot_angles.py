...
image_path = 'd:/banchan/usuk/1R.jpg'  # ← thay bằng tên ảnh thật

# Gọi hàm hiển thị
show_before_after(image_path)

# 2. Đọc dữ liệu từ file CSV với xử lý mã hóa và tên cột
csv_path = 'd:/banchan/usuk.csv'                    ####                                           Bộ  #############
image_folder = 'd:/banchan/usuk'                    ####              Bộ                               ############
...
# 8. Lưu mô hình
model.save('d:/banchan/flatfoot_model_usuk.keras')
print(" Mô hình đã được lưu vào 'flatfoot_model_usuk.keras'")
